    ...
    const handleTransfer = async () => {
      ...
      setTimeout(async  ()=>{
       ...
       try {
            ...
            // Navigate to payment page after successful transfer
            navigate(`/payment?id=${id}&name=${encodeURIComponent(name)}&amount=${amount}`);
                ...
                <div className="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                {isLoading ? "Processing..." : "Initiate Transfer"} {/* Show loader text */}
                            </button>
                        </div>
                    </div>
                </div>
